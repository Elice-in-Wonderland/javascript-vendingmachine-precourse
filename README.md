...
- [x] 사용자는 상단 탭에서 상품 관리, 잔돈 충전, 상품 구매 기능을 선택할 수 있다.
  - [x] 상품 관리 View를 만든다.
  - [x] 잔돈 충전 View를 만든다.
  - [x] 상품 구매 View를 만든다.
  - [x] 버튼 클릭에 따라 상단 탭 선택상태를 기억하고, 선택한 View를 렌더링 한다.
- [x] 사용자는 상품관리 탭에서 상품을 추가하고 확인할 수 있다.
  - [x] 상품명, 가격, 수량을 입력해 상품을 추가한다.
  - [x] 추가된 상품을 확인할 수 있다. 이때 상품 구매탭에서도 확인이 가능해야한다.
- [ ] 사용자는 잔돈 충전 탭에서 자판기의 잔돈을 충전하고, 보유한 동전의 개수를 확인할 수 있다.
  - [x] 충전할 금액을 입력하고, 버튼을 누르면 보유 금액을 충전할 수 있다.
  - [ ] 보유 금액만큼, 무작위로 동전을 생성한다.
  - [x] 기존 보유 금액이 있는상태에서 추가로 충전했을경우, 추가 충전만큼의 동전이 무작위로 생성되어 기존 동전들에 더해진다.
- [x] 사용자는 상품 구매 탭에서 금액을 투입할 수 있다.
  - [x] 투입 금액을 입력하고, 버튼을 누르면 금액이 투입된다.
- [x] 사용자는 상품 구매 탭에서 투입한 금액으로 상품을 구매할 수 있다.
  - [x] 품절된 상품의 구매하기 버튼은 disabled 시킨다.
- [x] 사용자는 상품 구매 탭에서 반환하기 버튼을 통해 잔돈을 받을 수 있다.
  - [x] 자판기가 현재 보유한 최소 개수의 동전으로 잔돈을 돌려준다.
