...
- [ ] 사용자는 상품관리 탭에서 상품을 추가하고 확인할 수 있다.
  - [ ] 상품명, 가격, 수량을 입력해 상품을 추가한다.
  - [ ] 추가된 상품을 확인할 수 있다. 이때 상품 구매탭에서도 확인이 가능해야한다.
- [ ] 사용자는 잔돈 충전 탭에서 자판기의 잔돈을 충전하고, 보유한 동전의 개수를 확인할 수 있다.
  - [ ] 충전할 금액을 입력하고, 버튼을 누르면 보유 금액을 충전할 수 있다.
  - [ ] 보유 금액만큼, 무작위로 동전을 생성한다.
  - [ ] 기존 보유 금액이 있는상태에서 추가로 충전했을경우, 추가 충전만큼의 동전이 무작위로 생성되어 기존 동전들에 더해진다.
